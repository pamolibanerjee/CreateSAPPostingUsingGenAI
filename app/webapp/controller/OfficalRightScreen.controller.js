sap.ui.define([
    ...
    return Controller.extend("createsofromchat.controller.OfficalRightScreen", {
        ...
        sendMessage: function (payload) {
            ...
            return new Promise((resolve, reject) => {
                ...
                $.ajax({
                    url: sessionStorage.getItem("isDeployedVersion") === "true" ? this.getBaseURL() + "/odata/v4/chat/getChatResponse" : "/odata/v4/chat/getChatResponse",
